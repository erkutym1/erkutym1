...
<div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
  <p style="flex: 1;">
    Professional projects and custom solutions in the fields of Artificial Intelligence (AI), Machine Learning (ML), Deep Learning, Image Processing, Signal Processing, and Web Development.
  </p>
